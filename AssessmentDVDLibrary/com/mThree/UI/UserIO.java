...
public interface UserIO {
     ...
     *Display a prompt to the user to enter an integer between a specified 
     *	min and max range, and read in an integer.
     * If the user's number does not fall within the range, 
     ...
     *  and max range, and read in a double.
     * If the user's number does not fall within the range,
     *  keep prompting the user for new input until it does.
     ...
     *  and max range, and read in a float.
     * If the user's number does not fall within the range,
     *  keep prompting the user for new input until it does.
     * The prompt message and min and max values should be passed in as parameters.
     * The value read in from the console should be the return of the method.
     ...
     * The prompt message value should be passed in as a parameter
     *  and the value that is read in should be the return of the method.
     * Display a prompt to the user to enter a long between a specified min
     *  and max range, and read in a long.
     * If the user's number does not fall within the range,
     *  keep prompting the user for new input until it does.
     * The prompt message and min and max values should be passed in as parameters.
     *  The value read in from the console should be the return of the method.
    ...
    // so we got, string, string/date/number, string/number, string, string, and string
    //thus we need a date
